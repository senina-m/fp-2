...
## Структура дерева
Дерево основанно на классе trie
...
Дерево представленно связанными узлами -- элементами этого класса.

Для каждого узла известен префикс -- символ, оторждествляющий этот узел. 

А так же у него есть массив суффиксов -- это все узлы -- дети представленные тем же классом tie.
